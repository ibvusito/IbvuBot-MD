...
conn.sendFile(m.chat, ss, 'error.png', teks, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 ', previewType: 0, thumbnail: imagen4, sourceUrl: accountsgb.getRandom()}}})
//m.reply(teks)
})
} catch {    
handler.limit = 0
