...
conn.reply(m.chat, `${mid.buscador9}\n\n` + res.result.isi, fkontak, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 | 𝙒𝙞𝙠𝙞𝙥𝙚𝙙𝙞𝙖', body: '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 ❤️',          previewType: 0, thumbnail: imagen2, sourceUrl: accountsgb.getRandom}}})
}).catch((e) => {
