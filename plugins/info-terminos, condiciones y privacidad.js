...
let Terminos = `*_Toda la informacion que se mencione aqui no excluye a la Propietario del Bot, y Propietarios Acredores al uso de 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓_*
...
_- Las Cuentas Oficiales de 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 no se hacen responsable del Uso que usted haga con la funci贸n "Sub Bot"._
...
_- Al hacer uso de ciertos comandos que tengan como objetivo socavar la incomodidad, intranquilidad, molestia u otro termino tajante, se tomarian las respectivas sanciones o llamados de alerta para prevalecer la integridad de los/las Usuarios(as) y funcionamiento de 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓._
...
*https://www.paypal.com/paypalme/fercho30052002q*

*~ Muchas Gracias Por tomarte el tiempo en informate sobre GataBot*` 
await conn.sendFile(m.chat, pp, 'gata.mp4', Terminos)
/*.trim()
conn.sendHydrated(m.chat, Terminos,  `${wm}\nEstamos de acuerdo en Hacer Colaboraciones con Personas Comprometidas, manteniendo el Respeto Puedes Contactar si ese es el caso a esta Cuenta Oficial | https://www.instagram.com/ifoqt/`, pp, 'https://github.com/ibvusito', '饾檪饾櫀饾櫓饾櫀饾樈饾櫎饾櫓-饾檲饾樋', null, null, [
