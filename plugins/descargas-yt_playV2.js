...
try {
if (command == 'play.1') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + mid.smsAud, m, { contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 | Ibvusito', body: '😻 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓', previewType: 0, thumbnail: gataImg.getRandom(),  sourceUrl: accountsgb.getRandom()}}}) 
try { 
...
if (command == 'play.2') {
conn.reply(m.chat, lenguajeGB['smsAvisoEG']() + mid.smsVid, m, {contextInfo: { externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 | Ibvusito', body: '😻 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓', previewType: 0, thumbnail: gataImg.getRandom(), sourceUrl: accountsgb.getRandom()}}}) 
try {
...
title: '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 | Ibvusito',
body: 'Super Bot WhatsApp',         
previewType: 0, thumbnail: fs.readFileSync("./media/menus/Menu3.jpg"),
sourceUrl: `https://github.com/ibvusito`}}}) 
