...
let enlace2 = { contextInfo: { externalAdReply: { showAdAttribution: true, mediaUrl: yt, mediaType: 'VIDEO', description: '', title: wm, body: '😻 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓', thumbnailUrl: await(await fetch(img)).buffer(), sourceUrl: yt }}}
...
//conn.sendHydrated(m.chat, text, wm, img5, md, '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓', null, null, [
