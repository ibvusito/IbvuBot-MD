        ...
        *—◉ #enable delete*
        ...
        global.dfail = (type, m, conn) => {
            let msg = {
                ...
                unreg: '╰⊱⚠️⊱ *𝘼𝘿𝙑𝙀𝙍𝙏𝙀𝙉𝘾𝙄𝘼 | 𝙒𝘼𝙍𝙉𝙄𝙉𝙂* ⊱⚠️⊱╮\n\n_*¡Qué esperas para estar Verificando(a) en IbvuBot-MD! Usa el comando #verificar*_\n_*What are you waiting for to be Verifying with IbvuBot-MD! Use the #verify command*_',
