...
await conn.sendFile(m.chat, gataImg.getRandom(), 'lp.jpg', info, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: ' 𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓 ', previewType: 0, thumbnail: imagen4, sourceUrl: accountsgb.getRandom()}}})
...
conn.sendHydrated(m.chat, info, wm, pp, 'https://github.com/ibvusito', '𝐈𝐁𝐕𝐔 - 𝐁𝐎𝐓', null, null, [
